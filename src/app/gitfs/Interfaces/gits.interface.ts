// To parse this data:
//
//   import { Convert, Searchmodule } from "./file";
//
//   const searchmodule = Convert.toSearchmodule(json);
//
...
export class Convert {
    public static toSearchmodule(json: string): Searchmodule {
        return cast(JSON.parse(json), r("Searchmodule"));
    }

    public static searchmoduleToJson(value: Searchmodule): string {
        return JSON.stringify(uncast(value, r("Searchmodule")), null, 2);
    }
}
